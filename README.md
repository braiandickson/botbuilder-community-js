...
| [@botbuildercommunity/adapter-keybase](libraries/botbuilder-adapter-keybase/README.md) | A platform adapter for the Keybase encrypted application | | [![NPM Version](https://img.shields.io/npm/v/@botbuildercommunity/adapter-keybase.svg)](https://www.npmjs.com/package/@botbuildercommunity/adapter-keybase) |
